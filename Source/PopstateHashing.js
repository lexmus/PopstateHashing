(function($) {
  ...
  var isIE6or7 = Browser.Engine ? (Browser.Engine.trident4 || Browser.Engine.trident5) : (Browser.ie6 || Browser.ie7);

  var onChange = function(path,state) {
    window.fireEvent('addressChange',[path,state || {}]);
  };
